      ...
      <div
        ...
        >
          {product.map((el) => (
            ...
            <button style={{background:"black",color:"teal"}} >View</button>
           </Link>
           <Link to={`/EditProduct/${el.id}`}>
              <button style={{background:"black", color:"white", margin:"0px 4px 4px"}} >Edit Price</button>
            </Link>

              
             <button style={{background:"black",color:"red"}} onClick={() => handleDelete(el.id)}>Delete</button>
            </div>
          ))}
        </div>
